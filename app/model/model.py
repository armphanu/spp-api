...
def predict_pipeline(created_time, message_tags, msg, pl, pg, type):
    ...
    if pred[0] == '0':
      ...
      if(type == 'classification'):
        ...
        pred1 = cu1g11.predict(df)
        pred2 = cu2g11.predict(df)
        pred3 = cu3g11.predict(df)
        pred4 = cu4g11.predict(df)
        pred5 = cu5g11.predict(df)
        pred6 = cu6g11.predict(df)
        pred7 = cu7g11.predict(df)
        pred8 = cu8g11.predict(df)
        pred9 = cu9g11.predict(df)
        pred10 = cu10g11.predict(df)
        pred11 = cu11g11.predict(df)
        pred12 = cu12g11.predict(df)
        pred13 = cu13g11.predict(df)
        pred14 = cu14g11.predict(df)
      ...
      if type == 'ranking':
        ...
        pred1 = cku1g11.predict(df)
        pred2 = cku2g11.predict(df)
        pred3 = cku3g11.predict(df)
        pred4 = cku4g11.predict(df)
        pred5 = cku5g11.predict(df)
        pred6 = cku6g11.predict(df)
        pred7 = cku7g11.predict(df)
        pred8 = cku8g11.predict(df)
        pred9 = cku9g11.predict(df)
        pred10 = cku10g11.predict(df)
        pred11 = cku11g11.predict(df)
        pred12 = cku12g11.predict(df)
        pred13 = cku13g11.predict(df)
        pred14 = cku14g11.predict(df)
      ...
      if type == 'regression':
        ...
        pred1 = ru1.predict(df)
        pred2 = ru2.predict(df)
        pred3 = ru3.predict(df)
        pred4 = ru4.predict(df)
        pred5 = ru5.predict(df)
        pred6 = ru6.predict(df)
        pred7 = ru7.predict(df)
        pred8 = ru8.predict(df)
        pred9 = ru9.predict(df)
        pred10 = ru10.predict(df)
        pred11 = ru11.predict(df)
        pred12 = ru12.predict(df)
        pred13 = ru13.predict(df)
        pred14 = ru14.predict(df)
